...
class MechCategory(object):
    ...
    def __init__(self):
        self.menu = [Buyers.CRotObjBuyer(Mech.SlowConv), Buyers.RotObjBuyer(Mech.Conv, 100),
                     ...
                     Buyers.ObjBuyer(Mech.Buffer5, 500),
...
class KeyPlayer(Entity.Entity):
    ...
    def __init__(self, num, bm):
        ...
        self.disable = False
        self.submenu = None
        self.menu = [Buyers.ObjBuyer(Object.Monolith, 30000), Buyers.TerrBuyer(2, 10),
                     Buyers.VBuyer(Vehicles.FastCar, 1000)]
        for tab in tabclasses:
            self.menu.append(tab())
        self.tools = [Tools.Wrench()]
