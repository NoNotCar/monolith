...
class MechCategory(object):
    ...
    doc="Tech stuff"
    def __init__(self):
        self.menu=[Buyers.RotObjBuyer(Mech.SlowConv,25),Buyers.RotObjBuyer(Mech.Conv,100),Buyers.RotObjBuyer(Mech.RainConv,1000),Buyers.RotObjBuyer(Mech.DownTunnel,200),Buyers.RotObjBuyer(Mech.UpTunnel,500),
