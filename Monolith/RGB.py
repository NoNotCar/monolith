...
class RGBCategory(object):
    ...
    def __init__(self):
        self.menu = [Buyers.ObjBuyer(RGBSred, 500), Buyers.ObjBuyer(RGBSgreen, 500), Buyers.ObjBuyer(RGBSblue, 500),
                     Buyers.ObjBuyer(RGBMixer, 500), Buyers.ObjBuyer(RGBBuyer, 500), Buyers.ObjBuyer(RGBSpect, 1000)]
...
class RGBCategoryPuzz(object):
    ...
    def __init__(self):
        self.menu = [Buyers.ObjBuyer(RGBSred, 500), Buyers.ObjBuyer(RGBSgreen, 500), Buyers.ObjBuyer(RGBSblue, 500),
                     Buyers.ObjBuyer(RGBMixer, 500), Buyers.ObjBuyer(RGBSpect, 1000)]
